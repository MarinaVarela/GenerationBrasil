...
CREATE INDEX `fk_tb_postagem_tb_temas_idx` ON `db_blog_pessoal`.`tb_postagem` (`tb_temas_id` ASC) VISIBLE;

CREATE INDEX `fk_tb_postagem_tb_usuario1_idx` ON `db_blog_pessoal`.`tb_postagem` (`tb_usuario_id` ASC) VISIBLE;
